...
uniswap_router = web3_client.eth.contract(
    address="0x68b3465833fb72A70ecDF485E0e4C7bD8665Fc45", abi=json.loads(open("uniswap_router_2.json").read())
)

quickswap_router = web3_client.eth.contract(
    address="0xa5E0829CaCEd8fFDD4De3c43696c57F7D7A678ff", abi=json.loads(open("quickswap_router.json").read())
)
